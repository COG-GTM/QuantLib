...
/*! \file optional.hpp
    \brief Deprecated: includes <optional>; use std::optional directly
*/
...
namespace QuantLib::ext {
    ...
    /*! \deprecated Use std::optional instead. Deprecated in version 1.43. */
    using std::optional;                    // NOLINT(misc-unused-using-decls)
    /*! \deprecated Use std::nullopt instead. Deprecated in version 1.43. */
