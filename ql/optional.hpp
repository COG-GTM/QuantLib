...
/*! \file optional.hpp
    \brief Deprecated forwarding header — include \<optional\> directly.
    \deprecated Include \<optional\> and use std::optional instead.
*/

#ifndef quantlib_optional_hpp
#define quantlib_optional_hpp

#pragma message("Warning: <ql/optional.hpp> is deprecated. Include <optional> and use std::optional directly.")
